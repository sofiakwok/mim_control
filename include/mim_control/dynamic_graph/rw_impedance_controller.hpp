...
{
/**
 * @brief Entity around the RWImpedanceController class of this package.
 */
class RWImpedanceController : public dynamicgraph::Entity
{
    DYNAMIC_GRAPH_ENTITY_DECL();

public:
    /**
     * @brief Construct a new RWImpedanceController object using its Dynamic Graph
     * name.
     *
     * @param name
     */
    RWImpedanceController(const std::string& name);
...
protected:
    ...
    /**
     * @brief Internally calls the RWImpedanceController class.
     *
     * @param signal_data
     * @param time
     * @return true
    ...
    mim_control::RWImpedanceController impedance_controller_;
