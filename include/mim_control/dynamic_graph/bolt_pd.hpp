...
{
/**
 * @brief Entity around the BoltPD class of this package.
 */
class BoltPD : public dynamicgraph::Entity
{
    DYNAMIC_GRAPH_ENTITY_DECL();

public:
    /**
     * @brief Construct a new BoltPD object using its Dynamic Graph
     * name.
     *
     * @param name
     */
    BoltPD(const std::string& name);
...
protected:
    ...
    /**
     * @brief Internally calls the BoltPD class.
     *
     * @param signal_data
     * @param time
     * @return true
    ...
    mim_control::BoltPD pd_controller_;
};
