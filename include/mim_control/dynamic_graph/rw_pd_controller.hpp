...
{
/**
 * @brief Entity around the RWPDController class of this package.
 */
class RWPDController : public dynamicgraph::Entity
{
    DYNAMIC_GRAPH_ENTITY_DECL();

public:
    /**
     * @brief Construct a new RWPDController object using its Dynamic Graph
     * name.
     *
     * @param name
     */
    RWPDController(const std::string& name);
...
protected:
    ...
    /**
     * @brief Internally calls the RWPDController class.
     *
     * @param signal_data
     * @param time
     * @return true
    ...
    mim_control::RWPDController rw_pd_controller_;
};
