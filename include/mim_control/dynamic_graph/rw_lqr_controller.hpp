...
{
/**
 * @brief Entity around the RWLQRController class of this package.
 */
class RWLQRController : public dynamicgraph::Entity
{
    DYNAMIC_GRAPH_ENTITY_DECL();

public:
    /**
     * @brief Construct a new RWLQRController object using its Dynamic Graph
     * name.
     *
     * @param name
     */
    RWLQRController(const std::string& name);
...
protected:
    ...
    /**
     * @brief Internally calls the RWLQRController class.
     *
     * @param signal_data
     * @param time
     * @return true
    ...
    mim_control::RWLQRController rw_lqr_controller_;
};
