 ...
 * Gesellschaft
 *
 * @brief Implementation of the RWImpedanceController class.
 */
...
void RWImpedanceController::run(
...
void RWImpedanceController::run_precomputed_data(
...
const Eigen::VectorXd& RWImpedanceController::get_torques()
{
    return torques_;
}

const Eigen::VectorXd& RWImpedanceController::get_joint_torques()
{
    return joint_torques_;
}

const RWImpedanceController::Vector6d& RWImpedanceController::get_impedance_force()
{
    return impedance_force_;
}

const pinocchio::FrameIndex& RWImpedanceController::get_endframe_index()
{
